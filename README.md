...
<img src="images/mpc/1.jpeg" height="165"/> <img src="images/mpc/2.jpeg" height="165"/> 
...
* 담당 업무
  ...
  * FCM Notification 추가, Android 무결성/루팅 검증, 앱 푸시 알림 분기, 자동로그인 기능 추가, webView 쿠키 관리, Google 정책 대응(SDK 버전 업데이트 permission 관리 등), Intro 속도 개선 등
