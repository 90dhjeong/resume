...
> 스포츠 경기의 승/패를 예상하는 앱이며 누적 다운로드가 20만을 넘었어요. 초기 기획 단계부터 참여하여 빌드업을 해 나갔어요. Swift로 처음 개발하는 프로젝트였어요. 크기가 큰 앱 개발을 초기 단계부터 시작할 때 클래스 하나를 생성할 때도 추후 사용성을 고려하고 나무보다 숲을 봐야하는 것을 배웠던 앱입니다. 1차 개발을 완료하고 AppStore출시까지 완료하였습니다. 
